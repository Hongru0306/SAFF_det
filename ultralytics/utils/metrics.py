    ...
    if CIoU or DIoU or GIoU or EIoU or SIoU or ShapeIoU or PIoU or PIoU2:
        ...
        if CIoU or DIoU or EIoU or SIoU or PIoU or PIoU2 or ShapeIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            if CIoU:  # https://github.com/Zzh-tju/DIoU-SSD-pytorch/blob/master/utils/box/box_utils.py#L47
                ...
                sin_alpha = torch.where(sin_alpha_1 > threshold, sin_alpha_2, sin_alpha_1)
                angle_cost = torch.cos(torch.arcsin(sin_alpha) * 2 - math.pi / 2)
                rho_x = (s_cw / (b1_x2.maximum(b2_x2) - b1_x1.minimum(b2_x1) + eps)) ** 2 # 使用凸包宽度代替 cw
                rho_y = (s_ch / (b1_y2.maximum(b2_y2) - b1_y1.minimum(b2_y1) + eps)) ** 2 # 使用凸包高度代替 ch
                gamma = angle_cost - 2
                ...
                return 1 - 3*x*torch.exp(-x**2)*piou_v1 - 0.1 * angle_distance_cost
