...
from ultralytics.nn.modules import (
    ...
    WorldDetect,
    A2C2f,
    v10Detect,IN, Multiin, MF, ConvNormLayer, BasicBlock, BottleNeck, Blocks
)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            SCDown,
            A2C2f,
            C2fCIB,MF, ConvNormLayer, BottleNeck
        }:
            c1, c2 = ch[f], args[0]
            ...
            args = [ch[f]]
        elif m in {Concat, Concat_Novel_obb, Concat2}:
